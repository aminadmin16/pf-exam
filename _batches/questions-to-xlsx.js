...
const coreRows = (W.QUESTIONS || []).map((q) => ({
  ...
  predicted: q.predicted ? "yes" : "", passage: q.passage || "",
  question: q.question,
...
XLSX.utils.book_append_sheet(wb, sheet(coreRows, ["subject", "topic", "year", "predicted", "passage", "question", "choice1", "choice2", "choice3", "choice4", "answer", "explanation", "freq"]), "core");
